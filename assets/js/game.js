...
var fight = function (enemy) {
  while (enemy.health > 0 && playerInfo.health > 0) {
    ...
    if (fightOrSkip()) {
      break; // if the method returns true then exit the fight
    } else {
...
var shop = function () {
  var shopOptionPrompt = window.prompt(
    " Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter 1 to  'REFILL', 2 to 'UPGRADE', 3 to 'LEAVE'"
  );
